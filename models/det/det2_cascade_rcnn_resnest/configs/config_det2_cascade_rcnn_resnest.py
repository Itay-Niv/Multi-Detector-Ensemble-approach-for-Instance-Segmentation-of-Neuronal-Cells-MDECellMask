...
# Define directories:
model_name = "det2_cascade_rcnn_resnest"
...
pretrain_weights = model_path + '/pretrained_weights/cascade_rcnn_s101_fpn_syncbn-backbone+head_mstrain-range_1x_coco_20201005_113242-b9459f8f.pth'
...
model = dict(
    type='CascadeRCNN',
        ...
        norm_cfg=norm_cfg,
        norm_eval=False,
        dcn=dict(type='DCN', deform_groups=1, fallback_on_stride=False),  #ITAY ADDED
        stage_with_dcn=(False, True, True, True),                         #ITAY ADDED
        style='pytorch',
